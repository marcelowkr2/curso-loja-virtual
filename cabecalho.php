<?php 
	$nomecliente = isset($_SESSION['cliente_curso']['CLIENTE']) ? $_SESSION['cliente_curso']['CLIENTE'] : '';
	if ($nomecliente == ""){
...
<div id="cabecalho_superior">
	<nav id="menu-cima">
		<span><?php echo "Olá $nomecliente Seja bem vindo à nossa loja"; ?></span>
		<ul>
