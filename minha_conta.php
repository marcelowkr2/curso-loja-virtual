...
session_start(); // Inicia a sessão
	...
	// Verifica se a sessão está definida e se o índice 'cliente_curso' existe
if (isset($_SESSION['cliente_curso']) && isset($_SESSION['cliente_curso']['ID'])) {
    $idCliente = $_SESSION['cliente_curso']['ID'];	
	
	 // Supondo que a classe Cliente já esteja incluída e $cliente seja uma instância de Cliente
	...
	<div id="conteudo_sanfona" class="formata_sanfona">
		...
		<div>
			...
			<div id="lista_venda">
				...
				<strong> C�digo do Rastreamento:</strong> <span> <?php echo $venda->getCodigoRastreamento(); ?> </span>
