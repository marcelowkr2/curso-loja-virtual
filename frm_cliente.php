<?php
    ...
    if (isset($_SESSION['cliente_curso']['IDCLIENTE'])) {
        ...
        // Caso a sessão não esteja definida, defina variáveis padrão ou mostre uma mensagem de erro
        ...
        <fieldset>
            ...
            <label>
                ...
                <select name="txt_uf">
                    ...
                    <option value="MA" <?php if($txt_uf == "MA") { echo "selected"; } ?>>Maranhão</option>
